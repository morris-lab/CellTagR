...
We recommend adding the CellTag UTR as a transgene to the reference used during alignment. This sequence is stored in https://github.com/morris-lab/CellTagR/blob/master/Examples/CellTag_UTR.fa. More information on adding a marker gene to a reference can be found here: https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/using/tutorial_mr.
